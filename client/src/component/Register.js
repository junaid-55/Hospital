...
const Register = ({ setAuth }) => {
  ...
  const { firstName, lastName, email, contact, password } = inputs;
  const onChange = (e) => {
  ...
  const onSubmitForm = async (e) => {
    ...
    try {
      const body = { firstName, lastName, email, password, contact, user_type };
            ...
            <div class="max-w-md w-full p-6">
              ...
              <div class="mt-4 text-sm text-gray-600 text-center">
                <p>
                  ...
                  <a href="/auth/login" class="text-black hover:underline">
                    Login here
                  </a>
                </p>
              </div>
